          ...
          + New Course
            ...
            <div className="grid grid-cols-3 gap-5 mr-4">  
                ...
                {classes.map((course) => (
                    ...
                    <Link to={`/courses/${userId}/course/${course.classid}/posts`}>
                        ...
                        <Link to={`/courses/${userId}/course/${course.classid}/posts`}  className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600" >Posts                           
